 ...
 * @LastEditors: happain
 * @LastEditTime: 2022-10-17 23:10:35
 * @Description:
-->
<template>
	<el-main>
		<el-card shadow="never" header="打开">
			<el-button type="primary" plain @click="open1"
				>打开个人信息</el-button
			>
			<el-button type="primary" plain @click="open2"
				>打开后执行</el-button
			>
			<el-alert
		...
		<el-card shadow="never" header="刷新" style="margin-top: 15px">
			<el-button type="primary" plain @click="refresh1"
				>刷新当前</el-button
			>
		</el-card>
		<el-card shadow="never" header="关闭" style="margin-top: 15px">
			...
			<el-button type="primary" plain @click="close3"
				>关闭后执行</el-button
			>
		</el-card>
		<el-card shadow="never" header="设置" style="margin-top: 15px">
			<el-form :inline="true">
				...
				<el-form-item>
					<el-button type="primary" plain @click="set1"
						>设置标题</el-button
					>
				</el-form-item>
			</el-form>
		...
		<el-card shadow="never" header="整页路由" style="margin-top: 15px">
			<el-button type="primary" plain @click="fullpage"
				>fullpage</el-button
			>
			<el-alert
